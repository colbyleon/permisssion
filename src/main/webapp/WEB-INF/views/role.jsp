...
<script type="text/javascript">
    $(function () {
        ...
        <!-- zTree -->
        <!-- 先将acl以及aclModule扁平化，以id，pid给ztree生成树 -->
        var zTreeObj = [];
        var modulePrefix = 'm_';
        var aclPrefix = 'a_';
        <!-- 权限模块map -->
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.ret) {
                        ...
                        showMessage("加载角色权限数据", result.msg);
                    }
                }
            });
        }
        ...
        $("#roleTab a[data-toggle='tab']").on("shown.bs.tab", function (e) {
            if (lastRoleId === -1) {
                showMessage("加载角色关系", "请先在在侧选择需要操作的角色", false);
            }
